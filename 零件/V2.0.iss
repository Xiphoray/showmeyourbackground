...
LicenseFile=E:\project_C#\showmeyourbackground\零件\lis.txt
OutputDir=E:\project_C#\showmeyourbackground\零件
OutputBaseFilename=showmeyourbackground V2.0
SetupIconFile=E:\project_C#\showmeyourbackground\零件\icon.ico
Compression=lzma
